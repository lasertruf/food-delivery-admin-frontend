...
goToDetails(){
  this.router.navigate(['/restaurants/details'], {queryParams:{id:this.restaurantId}})
}
...
onAddDish(){
  ...
  let menuData = {
    ...
    this.firestoreService.updateDataByRef(menuData,this.restaurantData.menuId).then(res=>{
      this.menuForm.reset();
